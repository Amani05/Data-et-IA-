...
régression logistique capture bien certaines relations linéaires, mais sa précision reste modérée.
...
| Polarité des Sentiments       | 87.61          |
| Subjectivité des Sentiments   | 94.17          |
...
- La standardisation et l'optimisation des hyperparamètres ont significativement amélioré la précision, faisant du KNN optimisé le modèle le plus performant.
...
1. **Meilleure Méthode** :
   - Le KNN optimisé avec `n_neighbors=19` a montré la meilleure précision (76.29%).
